...
#define nrn_init _nrn_init__AMPA2s
#define _nrn_initial _nrn_initial__AMPA2s
#define nrn_cur _nrn_cur__AMPA2s
#define _nrn_current _nrn_current__AMPA2s
#define nrn_jacob _nrn_jacob__AMPA2s
#define nrn_state _nrn_state__AMPA2s
#define _net_receive _net_receive__AMPA2s 
#define release release__AMPA2s 
...
#define Alpha Alpha_AMPA2s
 double Alpha = 0.94;
#define Beta Beta_AMPA2s
 double Beta = 0.18;
#define Cdur Cdur_AMPA2s
 double Cdur = 0.3;
#define Erev Erev_AMPA2s
 double Erev = 0;
#define Rtau Rtau_AMPA2s
 double Rtau = 0;
#define Rinf Rinf_AMPA2s
 double Rinf = 0;
 ...
 "Cdur_AMPA2s", &Cdur_AMPA2s,
 "Alpha_AMPA2s", &Alpha_AMPA2s,
 "Beta_AMPA2s", &Beta_AMPA2s,
 "Erev_AMPA2s", &Erev_AMPA2s,
 "Rinf_AMPA2s", &Rinf_AMPA2s,
 "Rtau_AMPA2s", &Rtau_AMPA2s,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 AMPA2s C:/Users/bpg/Desktop/Projects/CN book/Edition2/Exercises/Code-Edn1/Chapt7/Fig7.5/ampa2s.mod\n");
...
{
 { error =  release();
 if(error){fprintf(stderr,"at line 90 in file ampa2s.mod:\n	SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "ampa2s.mod";
static const char* nmodl_file_text = 
