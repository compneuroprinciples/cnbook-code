...
#define nrn_init _nrn_init__DESynapse
#define _nrn_initial _nrn_initial__DESynapse
#define nrn_cur _nrn_cur__DESynapse
#define _nrn_current _nrn_current__DESynapse
#define nrn_jacob _nrn_jacob__DESynapse
#define nrn_state _nrn_state__DESynapse
#define _net_receive _net_receive__DESynapse 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 1, "pntproc");
 	...
 	ivoc_help("help ?1 DESynapse C:/Users/bpg/Desktop/Projects/CN book/Edition2/Exercises/Code/Synapse/DEsyn.mod\n");
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   g = gmax * ( ( tau1 * tau2 ) / ( tau1 - tau2 ) ) * duale ( _threadargscomma_ ( t - onset ) / tau1 , ( t - onset ) / tau2 ) ;
   i = g * ( v - e ) ;
   }
 _current += i;
...
#if NMODL_TEXT
static const char* nmodl_filename = "DEsyn.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
