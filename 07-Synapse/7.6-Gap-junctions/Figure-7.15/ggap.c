...
#define nrn_init _nrn_init__Ggap
#define _nrn_initial _nrn_initial__Ggap
#define nrn_cur _nrn_cur__Ggap
#define _nrn_current _nrn_current__Ggap
#define nrn_jacob _nrn_jacob__Ggap
#define nrn_state _nrn_state__Ggap
#define _net_receive _net_receive__Ggap 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "pointer");
 	...
 	ivoc_help("help ?1 Ggap C:/Users/bpg/Desktop/Projects/CN book/Edition2/Exercises/Code-Edn1/Chapt7/Fig7.16/ggap.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "ggap.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "Gap junction model\n"
  "\n"
