...
#define nrn_init _nrn_init__cadifrb4
#define _nrn_initial _nrn_initial__cadifrb4
#define nrn_cur _nrn_cur__cadifrb4
#define _nrn_current _nrn_current__cadifrb4
#define nrn_jacob _nrn_jacob__cadifrb4
#define nrn_state _nrn_state__cadifrb4
#define _net_receive _net_receive__cadifrb4 
#define coord coord__cadifrb4 
#define state state__cadifrb4 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_cadifrb4", _hoc_setdata,
 "coord_cadifrb4", _hoc_coord,
 "ss_cadifrb4", _hoc_ss,
 0, 0
};
#define ss ss_cadifrb4
 extern double ss( );
 /* declare global and static user variables */
#define DFree DFree_cadifrb4
 double DFree = 0.23;
#define beta beta_cadifrb4
 double beta = 25;
#define cao cao_cadifrb4
 double cao = 0;
#define sthick sthick_cadifrb4
 double sthick = 0.1;
#define vol vol_cadifrb4
 double vol[4];
 ...
 "cao_cadifrb4", &cao_cadifrb4,
 "sthick_cadifrb4", &sthick_cadifrb4,
 "DFree_cadifrb4", &DFree_cadifrb4,
 "beta_cadifrb4", &beta_cadifrb4,
 0,0
};
 static DoubVec hoc_vdoub[] = {
 "vol_cadifrb4", vol_cadifrb4, 4,
 0,0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "diam");
 	...
 	ivoc_help("help ?1 cadifrb4 C:/Users/bpg/Desktop/Projects/CN book/Edition2/Chapter drafts/Chapt 6 - Intracellular/Scripts/My_Spine/cadifrb4.mod\n");
...
double ss (  ) {
 ...
 if(error){fprintf(stderr,"at line 118 in file cadifrb4.mod:\n	SOLVE state STEADYSTATE sparse\n"); nrn_complain(_p); abort_run(error);}
    if (secondorder) {
    int _i;
    for (_i = 0; _i < 4; ++_i) {
 ...
 */
 ...
 cai = ca [ 0 ] ;
 for (_i=0; _i < 4; _i++) { _p[_dlist1[_i + 0]] /= ( ( 1.0 + beta ) * diam * diam * vol [ ((int) _i ) ] * 1.0);}
   } return _reset;
 }
 ...
 v=_v;
{
 ...
 if(error){fprintf(stderr,"at line 70 in file cadifrb4.mod:\n	SOLVE state METHOD sparse\n"); nrn_complain(_p); abort_run(error);}
    if (secondorder) {
    int _i;
    for (_i = 0; _i < 4; ++_i) {
      _p[_slist1[_i]] += dt*_p[_dlist1[_i]];
...
#if NMODL_TEXT
static const char* nmodl_filename = "cadifrb4.mod";
static const char* nmodl_file_text = 
